...
from smalllib import of, ff #  folders helpers
...
np.savetxt(of("radargram_transform.txt"), T) # and save for future uses
...
xlabel("Distance")
ylabel("Depth")
savefig(ff("recreated.png"), dpi=300)


# %%
horizons_m.to_pickle(of("horizons.pickle")) #  we save them as pickle
stations.to_pickle(of("stations.pickle"))
